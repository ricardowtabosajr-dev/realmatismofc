              ...
              <div className="card" style={{ flex: 1 }}>
                ...
                {(() => {
                  ...
                  const F: Record<string, Slot[]> = {
                    // 3-line formations: ATK y=12, MID y=44, DEF y=75 (gaps: 32, 31)
                    // 4-line formations: ATK y=10, AM y=31, DM y=52, DEF y=73 (gaps: 21, 21, 21)
                    // All players in the same line share the EXACT same Y value
                    '4-4-2': [
                      { x: 35, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 65, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 10, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 37, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 63, y: 44, role: 'Cabeça de Area', color: '#3498db' }, { x: 90, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 10, y: 75, role: 'Lateral', color: '#e74c3c' }, { x: 37, y: 75, role: 'Zagueiro', color: '#e74c3c' },
                      { x: 63, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 90, y: 75, role: 'Lateral', color: '#e74c3c' },
                    ],
                    '4-3-3': [
                      { x: 15, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 50, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 85, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 30, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 50, y: 44, role: 'Cabeça de Area', color: '#3498db' }, { x: 70, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 10, y: 75, role: 'Lateral', color: '#e74c3c' }, { x: 37, y: 75, role: 'Zagueiro', color: '#e74c3c' },
                      { x: 63, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 90, y: 75, role: 'Lateral', color: '#e74c3c' },
                    ],
                    '4-5-1': [
                      { x: 50, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 10, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 30, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 50, y: 44, role: 'Cabeça de Area', color: '#3498db' }, { x: 70, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 90, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 10, y: 75, role: 'Lateral', color: '#e74c3c' }, { x: 37, y: 75, role: 'Zagueiro', color: '#e74c3c' },
                      { x: 63, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 90, y: 75, role: 'Lateral', color: '#e74c3c' },
                    ],
                    '4-2-3-1': [
                      { x: 50, y: 10, role: 'Atacante', color: '#f1c40f' },
                      { x: 15, y: 31, role: 'Meio-campo', color: '#3498db' }, { x: 50, y: 31, role: 'Meio-campo', color: '#3498db' }, { x: 85, y: 31, role: 'Meio-campo', color: '#3498db' },
                      { x: 37, y: 52, role: 'Cabeça de Area', color: '#9b59b6' }, { x: 63, y: 52, role: 'Cabeça de Area', color: '#9b59b6' },
                      { x: 10, y: 73, role: 'Lateral', color: '#e74c3c' }, { x: 37, y: 73, role: 'Zagueiro', color: '#e74c3c' },
                      { x: 63, y: 73, role: 'Zagueiro', color: '#e74c3c' }, { x: 90, y: 73, role: 'Lateral', color: '#e74c3c' },
                    ],
                    '3-5-2': [
                      { x: 35, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 65, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 10, y: 44, role: 'Lateral', color: '#3498db' }, { x: 30, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 50, y: 44, role: 'Cabeça de Area', color: '#3498db' }, { x: 70, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 90, y: 44, role: 'Lateral', color: '#3498db' },
                      { x: 25, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 50, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 75, y: 75, role: 'Zagueiro', color: '#e74c3c' },
                    ],
                    '3-4-3': [
                      { x: 15, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 50, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 85, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 10, y: 44, role: 'Lateral', color: '#3498db' }, { x: 37, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 63, y: 44, role: 'Cabeça de Area', color: '#3498db' }, { x: 90, y: 44, role: 'Lateral', color: '#3498db' },
                      { x: 25, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 50, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 75, y: 75, role: 'Zagueiro', color: '#e74c3c' },
                    ],
                    '5-3-2': [
                      { x: 35, y: 12, role: 'Atacante', color: '#f1c40f' }, { x: 65, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 30, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 50, y: 44, role: 'Cabeça de Area', color: '#3498db' }, { x: 70, y: 44, role: 'Meio-campo', color: '#3498db' },
                      { x: 8, y: 75, role: 'Lateral', color: '#e74c3c' }, { x: 30, y: 75, role: 'Zagueiro', color: '#e74c3c' },
                      { x: 50, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 70, y: 75, role: 'Zagueiro', color: '#e74c3c' }, { x: 92, y: 75, role: 'Lateral', color: '#e74c3c' },
                    ],
                    '5-4-1': [
                      { x: 50, y: 12, role: 'Atacante', color: '#f1c40f' },
                      { x: 10, y: 44, role: 'Meio-campo', color: '#3498db' }, { x: 37, y: 44, role: 'Meio-campo', color: '#3498db' },
