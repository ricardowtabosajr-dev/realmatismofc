                ...
                {(() => {
                  ...
                  const F: Record<string, Slot[]> = {
                    ...
                    '5-3-2': [
                      ...
                      { x: 8, y: 68, role: 'Lateral', color: '#e74c3c' }, { x: 30, y: 68, role: 'Zagueiro', color: '#e74c3c' },
                      { x: 50, y: 68, role: 'Zagueiro', color: '#e74c3c' }, { x: 70, y: 68, role: 'Zagueiro', color: '#e74c3c' }, { x: 92, y: 68, role: 'Lateral', color: '#e74c3c' },
                    ],
                    '5-4-1': [
                      { x: 50, y: 12, role: 'Atacante', color: '#f1c40f' },
